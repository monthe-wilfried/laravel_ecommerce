...
@section('content')
    ...
    @php
        $features = \App\Product::where('status',1)->orderBy('id','desc')->limit(12)->get();
        $trends = \App\Product::where('status',1)->where('trend',1)->orderBy('id','desc')->limit(12)->get();
        $best_rates = \App\Product::where('status',1)->where('best_rated',1)->orderBy('id','desc')->limit(12)->get();
        $hotDeals = \App\Product::where('status',1)->where('hot_deal',1)->orderBy('id','desc')->limit(12)->get();
        $hot_news = \App\Product::where('status',1)->where('hot_new',1)->orderBy('id','desc')->limit(3)->get();

        $categs = \App\Category::all();
        $mid_sliders = \App\Product::where('status',1)->where('mid_slider',1)->orderBy('id','desc')->limit(3)->get();
    @endphp
                            ...
                            @foreach($hotDeals as $hotDeal)
                                <!-- Deals Item -->
                                    <div class="owl-item deals_item">
                                        <div class="deals_image"><img src="{{ $hotDeal->image_one }}" alt=""></div>
                                        <div class="deals_content">
                                            <div class="deals_info_line d-flex flex-row justify-content-start">
                                                <div class="deals_item_category"><a href="#">{{ $hotDeal->brand->name }}</a></div>
                                    ...
                                    <!-- Slider Item -->
                                        <div class="featured_slider_item">
                                            ...
                                            <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($feature->image_one) }}" style="height: 120px; width: 140px;"></div>
                                                <div class="product_content">
                                                    <div class="product_price discount">
                                                        @if($feature->discount_price)
                                                            ${{ $feature->discount_price }}
                                                            <span>${{ $feature->selling_price }}</span>
                                                        @else
                                                            ${{ $feature->selling_price }}
                                                        @endif
                                                    </div>
                                                    <div class="product_name"><div><a href="{{ url('product/details/'.$feature->id.'/'.str_slug($feature->product_name)) }}">{{ $feature->product_name }}</a></div></div>
...
{{--                                                    </div>--}}
                                                ...
                                                <ul class="product_marks">
                                                    @if($feature->discount_price)
                                                        <li class="product_mark product_discount">
                                                            {{ intval((($feature->discount_price - $feature->selling_price) / $feature->selling_price) * 100) }}%
                                                        </li>
                                                    @else
                                ...
                                <div class="row fill_height">
                                    <div class="col-lg-4 col-md-6 fill_height">
                                        <div class="banner_2_content">
                                            <div class="banner_2_category"><h4>{{ $mid_slider->category->name }}</h4></div>
                                            <div class="banner_2_title">{{ $mid_slider->product_name }}</div>
                                            <div class="banner_2_text"><h4>{{ $mid_slider->brand->name }}</h4> <br>
                                                <h2>${{ $mid_slider->selling_price }}</h2>
                                            </div>
                                    ...
                                    <div class="col-lg-8 col-md-6 fill_height">
                                        <div class="banner_2_image_container">
                                            <div class="banner_2_image"><img src="{{ asset($mid_slider->image_one) }}" style="width: 250px; height: 300px;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @php
        ...
        $womanCategory = \App\Category::where('name', 'Womens Fashion')->first();
        $womanProducts = \App\Product::where('status',1)->where('category_id',$womanCategory->id)->limit(10)->orderBy('id','desc')->get();
                ...
                <div class="col">
                    <div class="tabbed_container">
                        <div class="tabs clearfix tabs-right">
                            <div class="new_arrivals_title">{{ $womanCategory->name }}</div>
                            <ul class="clearfix">
                                <li class="active"></li>
                            </ul>
                            <div class="tabs_line"><span></span></div>
                                    ...
                                    @foreach($womanProducts as $womanProduct)
                                        <!-- Slider Item -->
                                            <div class="featured_slider_item">
                                                <div class="border_active"></div>
                                                <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($womanProduct->image_one) }}" style="height: 120px; width: 140px;"></div>
                                                    <div class="product_content">
                                                        <div class="product_price discount">
                                                            @if($womanProduct->discount_price)
                                                                ${{ $womanProduct->discount_price }}
                                                                <span>${{ $womanProduct->selling_price }}</span>
                                                            @else
                                                                ${{ $womanProduct->selling_price }}
                                                            @endif
                                                        </div>
                                                    ...
                                                    <button class="addwishlist" data-id="{{ $womanProduct->id }}">
                                                        <div class="product_fav"><i class="fas fa-heart"></i></div>
                                                    </button>
                                                    ...
                                                    <ul class="product_marks">
                                                        @if($womanProduct->discount_price)
                                                            <li class="product_mark product_discount">
                                                                {{ intval((($womanProduct->discount_price - $womanProduct->selling_price) / $womanProduct->selling_price) * 100) }}%
                                                            </li>
                                                        @else
                                                            <li class="product_mark product_discount" style="background: blue;">New</li>
                                                        @endif
    ...
    @php
        ...
        $watchCategory = \App\Category::where('name', 'Watch')->first();
        $watchProducts = \App\Product::where('status',1)->where('category_id',$watchCategory->id)->limit(10)->orderBy('id','desc')->get();
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="tabbed_container">
                        <div class="tabs clearfix tabs-right">
                            <div class="new_arrivals_title">{{ $watchCategory->name }}</div>
                            <ul class="clearfix">
                                <li class="active"></li>
                            </ul>
                            <div class="tabs_line"><span></span></div>
                                    ...
                                    @foreach($watchProducts as $watchProduct)
                                        <!-- Slider Item -->
                                            <div class="featured_slider_item">
                                                <div class="border_active"></div>
                                                <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($watchProduct->image_one) }}" style="height: 120px; width: 140px;"></div>
                                                    <div class="product_content">
                                                        <div class="product_price discount">
                                                            @if($watchProduct->discount_price)
                                                                ${{ $watchProduct->discount_price }}
                                                                <span>${{ $watchProduct->selling_price }}</span>
                                                            @else
                                                                ${{ $watchProduct->selling_price }}
                                                            @endif
                                                        </div>
                                                    ...
                                                    <button class="addwishlist" data-id="{{ $watchProduct->id }}">
                                                        <div class="product_fav"><i class="fas fa-heart"></i></div>
                                                    </button>
                                                    ...
                                                    <ul class="product_marks">
                                                        @if($watchProduct->discount_price)
                                                            <li class="product_mark product_discount">
                                                                {{ intval((($watchProduct->discount_price - $watchProduct->selling_price) / $watchProduct->selling_price) * 100) }}%
                                                            </li>
                                                        @else
                                                            <li class="product_mark product_discount" style="background: blue;">New</li>
                                                        @endif
    ...
    @php
        $buyoneProducts = \App\Product::where('status',1)->where('buyone_getone',1)->orderBy('id','desc')->limit(4)->get();
    @endphp
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="trends_slider_container">
                        ...
                        @foreach($buyoneProducts as $buyoneProduct)
                            <!-- Trends Slider Item -->
                                <div class="owl-item">
                                    <div class="trends_item is_new">
                                        <div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{ $buyoneProduct->image_one }}" alt=""></div>
                                        <div class="trends_content">
                                            <div class="trends_category"><a href="#">{{ $buyoneProduct->brand->name }}</a></div>
                                            <div class="trends_info clearfix">
                                                <div class="trends_name"><a href="product.html">{{ $buyoneProduct->product_name }}</a></div>
                                                <div class="product_price discount">
                                                    @if($buyoneProduct->discount_price)
                                                        ${{ $buyoneProduct->discount_price }}
                                                        <span>${{ $buyoneProduct->selling_price }}</span>
                                                    @else
                                                        ${{ $buyoneProduct->selling_price }}
                                                    @endif
                                                </div>
                                        ...
                                        <ul class="trends_marks">
                                            @if($buyoneProduct->discount_price)
                                                <li class="trends_mark trends_new" style="background: red">
                                                    {{ intval((($buyoneProduct->discount_price - $buyoneProduct->selling_price) / $buyoneProduct->selling_price) * 100) }}%
                                                </li>
                                            @else
                                                <li class="trends_mark trends_new" style="background: blue;">New</li>
                                            @endif
                                        </ul>
                                        <button class="addwishlist" data-id="{{ $buyoneProduct->id }}">
