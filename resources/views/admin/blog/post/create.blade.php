                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="title_en" placeholder="Enter post title in english" value="{{ old('title_en') }}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="title_de" placeholder="Enter post title in german"  value="{{ old('title_de') }}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" name="details_en" class="form-control">{{ old('details_en') }}</textarea>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote2" name="details_de" class="form-control">{{ old('details_de') }}</textarea>
